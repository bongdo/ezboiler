export const BRANDS_DATA = [
  {
    ...
    models: [
      ...
      "BAXI MAIN DIGIT", "BAXI MAIN-5", "BAXI SLIM (напольные котлы)"
    ]
  },
  {
    name: "NAVIEN",
    models: [
      "NAVIEN ACE / DELUXE", "NAVIEN C / E", "NAVIEN S / ONE"
    ]
  },
  {
    name: "ZONT",
    description: "Системы удаленного контроля и регулирования",
    models: [
      "ZONT Системы удаленного контроля и регулирования"
    ]
  },
  {
    name: "VAILLANT",
  ...
  },
  {
    name: "PROTHERM",
    models: [
      "PROTHERM LYNX HK", "PROTHERM ГЕПАРД", "PROTHERM ПАНТЕРА",
      "PROTHERM ЯГУАР JTV", "PROTHERM ЛЕОПАРД (вер. 17)",
      "PROTHERM РЫСЬ 23 BTVE/BOVE RD", "PROTHERM МЕДВЕДЬ KLO",
      "PROTHERM МЕДВЕДЬ KLOM", "PROTHERM МЕДВЕДЬ KLZ",
      "PROTHERM МЕДВЕДЬ PLO", "PROTHERM МЕДВЕДЬ TLO", "PROTHERM СКАТ"
    ]
  },
  {
    name: "VIESSMANN",
  ...
  },
  {
    name: "BUDERUS",
    models: [
      "BUDERUS LOGAMAX U072", "BUDERUS LOGAMAX U012 / U014",
      "BUDERUS LOGAMAX U022 / U024", "BUDERUS LOGAMAX U032 / U034",
      "BUDERUS LOGAMAX U042 / U044", "BUDERUS LOGAMAX U052 / U054",
  ...
  {
    name: "IMMERGAS",
    models: ["IMMERGAS NIKE MYTHOS", "IMMERGAS MAJOR", "IMMERGAS MINI", "IMMERGAS STAR"]
  },
  {
    name: "JUNKERS",
  ...
  },
  {
    name: "KOREASTAR",
    models: [
      "KOREASTAR PREMIUM E (Turbo C)", "KOREASTAR ACE A/K", "KOREASTAR BRAVO E",
      "KOREASTAR BRAVO K", "KOREASTAR BURAN",
      "KOREASTAR PREMIUM A/E (Латунная гидрогруппа)",
      "KOREASTAR PREMIUM ES", "KOREASTAR PRESIDENT",
      "KOREASTAR SENATOR D", "KOREASTAR SENATOR T, TP"
    ]
  },
  {
    name: "MASTER",
